...
public:
    ...
    void can5_ReceiveFrame(can_frame_t *frame);
    ...
    void Send_Chassis_CMD(int vx,int vz,int mode,int vy);
    void Send_Chassis_CMD2(float vel_1,float vel_2,float vel_3);
